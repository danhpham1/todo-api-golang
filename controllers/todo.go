...
func (todo *TodoController) GetAll() {
	...
	SentryEvent(todo.Ctx.Request, "TdoService GetAll")
...
func (todo *TodoController) Post() {
	...
	SentryEvent(todo.Ctx.Request, "TdoService Create")
...
func (todo *TodoController) GetTodoById() {
	...
	SentryEvent(todo.Ctx.Request, "TdoService Get By Id")
...
func (todo *TodoController) Put() {
	...
	if id != "" {
		...
		SentryEvent(todo.Ctx.Request, "TdoService Update")
...
func (todo *TodoController) Delete() {
	...
	SentryEvent(todo.Ctx.Request, "TdoService Delete")
